...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col min-w-0  h-dvh bg-background">
      ...
      {aboutYou === "" && recentTransactions === "" && yourLikings === "" ? (
        <div className="mx-auto p-4 text-black  text-xl ">
          We are processing your data, please wait for a moment⏳
        </div>
      ) : (
        <div className="mx-auto flex flex-row justify-center w-full gap-4 p-4">
          <Cards title="About You" description={aboutYou} />
          <Cards title="Recent Transactions" description={recentTransactions} />
